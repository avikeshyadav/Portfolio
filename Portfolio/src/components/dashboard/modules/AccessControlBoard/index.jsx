...
const AccessControlBoard = () => (
  <div className="rounded-2xl border border-slate-800 bg-slate-900/90 p-4 shadow-lg">
    ...
    <p className="mt-3 text-sm leading-6 text-slate-400">Grant or deny campus entry through facial verification.</p>
  </div>
);

export default AccessControlBoard;
